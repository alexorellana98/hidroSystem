          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Listado de Propietarios de Pozos</h3>
              </div>
            ...
            <div class="row">
              ...
              $query = mysqli_query ($mysqli,"SELECT pp.nombre as nombre_propietario, pp.direccion, pp.telfijo, pp.telcelular FROM propietariospozos pp;");
