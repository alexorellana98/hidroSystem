          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Hoja de Visita a los Pozos</h3>
              </div>
            ...
            <div class="row">
              ...
              $query = mysqli_query ($mysqli,"SELECT p.tipo,v.nombre as nombre_de_visitante, hvp.fechavisita,p.codigopozo ,hvp.observacion FROM pozos p INNER JOIN hojavisitaspozos hvp
